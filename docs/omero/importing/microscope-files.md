...
### ImageXpress .JDCE
Data from the new [ImageXpress HT.ai](../../microscopes/mic_pages/imagexpress-hcsai.md) cannot be imported directly via OMERO.insight. Check out [this page](imagexpress-ai.md) for the latest instructions. For now files can only be uploaded from the microscope computer itself.
