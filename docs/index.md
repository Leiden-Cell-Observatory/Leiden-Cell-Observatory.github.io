...
<div style="border: 2px solid #e07b39; border-radius: 8px; padding: 1rem 1.2rem 0.8rem; margin-bottom: 1.5rem;">
<h2 style="margin-top: 0;">Submit your photos now to the Van Leeuwenhoek Awards 2026!</h2>

<div style="display: flex; gap: 1rem; align-items: flex-start; flex-wrap: wrap;">
  <div style="flex: 1 1 220px; max-width: 540px; display: flex; flex-direction: column; gap: 0.6rem;">
    <img src="courses/images/competition2026a.png" alt="Van Leeuwenhoek Awards 2026 – Leiden Micrograph Contest" style="width: 100%; height: auto; object-fit: contain;">
    <p style="margin: 0;"><strong>Submission deadline: 22 May</strong> &nbsp;·&nbsp; <a href="courses/photocompetition2026/">More info</a></p>
  </div>
  <img src="courses/images/competition2026b.png" alt="Previous winning micrographs" style="flex: 2 1 300px; max-width: 560px; height: auto; object-fit: cover; border-radius: 4px;">
</div>

<p style="font-size: 0.72rem; color: var(--md-default-fg-color--light); margin: 0;">
